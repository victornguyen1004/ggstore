          ...
          <div className="grid grid-cols-12 gap-12 px-24">
            <div className="col-span-6">
              ...
              <div className="text-justify indent-8 text-lg tracking-tighter">
                ...
                website. You might have known me as Victor Web Developing. My
                main goal is to become a full-stack web developer. At the moment
                you reading this, the team is just me but it will expand in
                future project.
              </div>
            </div>
            <div className="col-span-6">
              ...
              <div className="text-justify indent-8 text-lg tracking-tighter">
                ...
                Designing class. I found the project to be interesting so I
                built the whole app later on, including the Front-End, Back-End,
                API,...
              </div>
            </div>
            ...
            <div className="col-span-12 grid grid-cols-12 gap-x-12 gap-y-12">
              ...
              <div className="col-span-6">
                ...
                <div className="text-justify align-middle tracking-tighter">
                  A framework based on Javascript Language to create the face of
                  a website. The backbones of this website. Provide tools to
                  create the best UI/UX. Gift from heaven for these modern
                  websites. Cannot be as smooth as butter without ReactJS.
                </div>
              </div>
              ...
              <div className="col-span-6">
                ...
                <div className="text-justify align-middle tracking-tight">
                  Seeing more CSS files getting added to the project tree
                  overtime can be irritating. Using TailwindCSS not only make my
                  project tree cleaner, but also speed up my writing speed. I've
                  been able to create variaties of pages in a surprisingly short
                  time thanks to TailwindCSS.
                </div>
              </div>
              <div className="col-span-3 flex items-center justify-center">
                <img
