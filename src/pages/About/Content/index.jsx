...
function AboutContent() {
    return (
        <div className="grid grid-cols-12 gap-12 px-24 py-44 text-white bg-[#1f1f1f]">
          
          <div className="col-span-6">
            <div className="pb-4 text-right text-2xl font-bold">
              The Founder Of GGStore
            </div>
            <div className="text-justify indent-8 text-lg tracking-tighter">
              I am Nguyen Quang Vu aka Victor Nguyen, the founder of this
              website. You might have known me as Victor Web Developing. My main
              goal is to become a full-stack web developer. At the moment you
              reading this, the team is just me but it will expand in future
              project.
            </div>
          </div>
          <div className="col-span-6">
            ...
            <div className="text-justify indent-8 text-lg tracking-tighter">
              This project was built from scratch in my junior year of
              university. At the beginning it just a Figma prototype for my
              Designing class. I found the project to be interesting so I built
              the whole app later on, including the Front-End, Back-End, API,...
            </div>
          </div>

          <div className="col-span-12 grid grid-cols-12 gap-x-12 gap-y-12 py-36">
            <div className="col-span-12 text-center text-2xl font-bold">
              For more info, hit me on
            </div>
            <a
              href="tel:555-555-5555"
              className="group col-span-4 pb-4 text-center font-medium"
            >
          ...
          <div className="col-span-12 grid grid-cols-12 gap-x-12 gap-y-12">
            ...
            <div className="col-span-6">
              ...
              <div className="text-justify align-middle tracking-tighter">
                ...
                website. The backbones of this website. Provide tools to create
                the best UI/UX. Gift from heaven for these modern websites.
                Cannot be as smooth as butter without ReactJS.
              </div>
            </div>
            ...
            <div className="col-span-6">
              ...
              <div className="text-justify align-middle tracking-tight">
                Seeing more CSS files getting added to the project tree overtime
                can be irritating. Using TailwindCSS not only make my project
                tree cleaner, but also speed up my writing speed. I've been able
                to create variaties of pages in a surprisingly short time thanks
                to TailwindCSS.
              </div>
            </div>
            <div className="col-span-3 flex items-center justify-center">
            ...
            <div className="col-span-6">
              ...
              <div className="text-justify align-middle tracking-tighter">
                To create the first API I've ever created. At the beginning my
                aim was to become a Front-end Developer. But later on I got to
                learned all the Database and Backend by myself since nobody
                provides me a backend. Then I encountered the urge to become a
